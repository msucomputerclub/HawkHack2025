...
const About = () => {
    return (
        <div className="about">
            <div className="text">
                <h1>Welcome to Hawk Hack,</h1>
                <p>Where creativity meets technology! This event was designed to bring together developers, designers, entrepreneurs
                ...
                <br />
                <p>Over the course of 48 hours, teams will collaborate to create innovative solutions, tackle real-world challenges,
                    and showcase their skills, with the possibly winning a prize at the end!
                </p>
                <br />
                <p>Join us as we push the limits of innovation!</p>
            </div>
